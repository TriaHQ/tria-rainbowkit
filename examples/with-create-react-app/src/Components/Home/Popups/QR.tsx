        ...
        <div className="flex-col justify-start items-center flex rounded-lg">
                <div className="w-80 h-[304px] px-5 py-3 bg-white flex-col justify-start items-center gap-2 inline-flex  shadow-lg  rounded-lg">
                    <div className="w-[280px] h-[280px] relative">
                        ...
                        <div className="w-[92px] h-[92px] left-[94px] top-[94px] absolute bg-black rounded-[23px]">
                            <img className="w-[92px] h-[92px] left-0 top-0 absolute" src="/insideQR.png" />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="self-stretch justify-start items-center gap-4 inline-flex">
                        <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                <div className="text-center text-stone-950 text-opacity-80 text-base font-semibold  leading-tight">Your solana address</div>
                            </div>
