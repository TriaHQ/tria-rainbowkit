            ...
            <div className="self-stretch p-2 justify-between items-center inline-flex">
              <div className="grow shrink basis-0 h-11 justify-between items-center flex">
                <div className="justify-center items-center flex">
                  ...
                  <div className="text-center text-black bg-opacity-90 text-opacity-80 text-lg font-montserrat font-semibold leading-6">thekaypo@tria</div>
                  </div>
                ...
                <div className="justify-end items-center gap-2 flex">
                  <div className="p-2 bg-white rounded-[45px]  justify-start items-center gap-2 flex">
                    <div className="w-[18px] h-[18px] flex justify-center items-center">
                      <img className="w-8 h-8 " src="/icons/copy.svg" />
                    </div>
                  </div>
                  <div className="p-2 rounded-[45px] border justify-start items-center  flex  bg-violet-600">
