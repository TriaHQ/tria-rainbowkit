...
import HomeBackgroundVector from "../UI/HomeBackgroundVector";
  ...
  return (
    <>
      <div className="flex items-center justify-center relative ">
        ...
        <div className="w-[430px] h-90vh p-2 flex-col justify-center items-center gap-3 inline-flex bg-white rounded-xl font-montserrat">
          ...
          <div className="w-[416px] grow  flex-col justify-start items-center flex">
            <div className="self-stretch h-[345px] flex-col justify-center items-center flex">
              <div className="self-stretch h-[120px] px-5 rounded-2xl flex-col justify-center items-center gap-3 flex">
                <div className="self-stretch pt-8 justify-start items-center gap-4 inline-flex">
                  ...
                  <div className="grow shrink basis-0 h-[34px] px-3 py-2 bg-stone-50 rounded-[30px] justify-start items-center gap-3 flex">
                    <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">
                      <div className="self-stretch justify-between items-center inline-flex">
                        <input
                          className=" w-full text-stone-950  bg-stone-50 text-opacity-40 text-sm font-medium "
              ...
              <div className="self-stretch px-5 py-4 justify-start items-center gap-4 inline-flex">
