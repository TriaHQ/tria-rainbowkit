...
function BuyCrypto() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-black font-Montserrat">
      <div className="w-[448px] h-[840px] p-4 flex-col justify-center items-center gap-3 inline-flex bg-white rounded-xl font-montserrat">
        <div className="w-[416px] grow shrink basis-0 flex-col justify-start items-center flex">
          <Nav />
          <div className="w-[448px] h-[730px] p-4 flex-col justify-center items-center gap-3 inline-flex">
            <div className="w-[416px] grow shrink basis-0 flex-col justify-start items-center flex">
                    ...
                    <div className="grow shrink basis-0 h-[34px] px-3 py-2 bg-stone-50 rounded-[30px] justify-start items-center gap-3 flex">
                      <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">
                        <div className="self-stretch justify-between items-center inline-flex">
                          <input className="focus:border-none w-full text-stone-950 text-opacity-40 text-sm font-medium " placeholder=" Search crypto">
                          </input>
